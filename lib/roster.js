...
/**
 * Email lookup first (exact identity when it hits), falling back to an
 * exact name match — covers the case where the calendar invite's email
 * doesn't correspond to any Slack account (wrong/stale domain, personal
 * vs work address, etc.) but the captured display name still does.
 */
