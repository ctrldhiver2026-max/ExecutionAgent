...
//
// Output contract (per CLAUDE.md §5, consumed by Charan's roster/role-resolution
// step, which then calls Hari's POST /api/slack/confirm — see README.md
// "Integration seams"):
...
const EXTRACT_TOOL = {
  ...
  input_schema: {
    ...
    required: ["project_name", "deliverables", "due_dates"],
  },
};
