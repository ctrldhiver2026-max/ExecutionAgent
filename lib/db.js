 ...
 */
export async function createPendingReview({ channel_id, subtask_id, subtask_name, assignee_slack_id, approver_slack_id }) {
...
/** Most recent pending review in this channel awaiting approval from this specific person — first match wins since rows arrive newest-first. */
...
/** Consume a pending review once it's been approved (or just to clean up) so the same reply can't double-fire. */
